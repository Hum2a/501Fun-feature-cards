...
add_action('wp_enqueue_scripts', function () {
  wp_enqueue_script(
    'feature-cards',
    'https://cdn.jsdelivr.net/npm/@techystuff/feature-cards@1.0.5/dist/feature-cards.iife.js',
    [],
    '1.2.0',
    true // footer
  );
...
```html
<script
  src="https://cdn.jsdelivr.net/npm/@techystuff/feature-cards@1.0.5/dist/feature-cards.iife.js"
  integrity="sha384-…"
...
<div id="cards"></div>
<script type="module">
  import { createFeatureCards } from 'https://cdn.jsdelivr.net/npm/@techystuff/feature-cards@1.0.5/+esm';
