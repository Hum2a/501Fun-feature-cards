...
**npm:** Public package on npm + manual commercial agreements. No license
keys or private registry in v1 — see [docs/INSTALL.md](docs/INSTALL.md) (consumers)
and [docs/NPM-PUBLISH.md](docs/NPM-PUBLISH.md) (maintainers).
...
Setup and publish: **[docs/NPM-PUBLISH.md](docs/NPM-PUBLISH.md)**.
...
After publish, update version pins in **[docs/INSTALL.md](docs/INSTALL.md)**.
...
- [docs/INSTALL.md](docs/INSTALL.md) — consumer install guide
- [docs/NPM-PUBLISH.md](docs/NPM-PUBLISH.md) — maintainer publish playbook
